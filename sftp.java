...
public class sftp {
    ...
    public static void usage_and_exit() {
        System.err.println("java -jar sftp.jar [GET|PUT] user@remote_ip:remote_file local_file [-m] [-bBlockSize] [-sSleepTm] [-iID_rsa_file | -pPasswd] [-Pport] ");
        ...
        System.err.println("    GET | get     : get remote_file to local_file  (Success:0, Error:255)");
        System.err.println("    PUT | put     : put local_file  to remote_file (Success:0, Error:255)");
        System.err.println("    LS  | ls      : ls  remote_file (Success:0, Not Found:255)");
        System.err.println("    RM  | rm      : rm  remote_file (Success:0, Error:255)");
    ...
    public static void main(String args[]) throws Exception 
    {
        ...
        try {
            ...
            if ("ls".equals(func) || "LS".equals(func)) {
                ...
                if (is_msg) System.out.println("\ntotal " + total_tran_len + " byte");
                try{ in.close(); } catch  (Exception e) {}
                try{ out.close(); } catch  (Exception e) {}
            }
            if (is_msg) System.err.print("\n");
